                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="py-3 text-center">
                                ...
                                <p class="d-inline text-warning " style="font-weight: bold;">อนุญาติการใช้งานระบบ</p>

                            </div>
                        </div>
                        <div class="card-footer">
                            <a class="btn btn-success" href="?id=<?= $row['user_id'] ?>">อนุญาติ</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
